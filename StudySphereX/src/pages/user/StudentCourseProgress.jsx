...
export const StudentCourseProgress = () => {
  ...
  const { studentCurrentCourseProgress, setStudentCurrentCourseProgress, setCurrentCourseMeta, currentCourseMeta } =
...
setStudentCurrentCourseProgress(response.data);

setCurrentCourseMeta({
  id: response.data.courseDetails._id,
  title: response.data.courseDetails.title,
  instructorName: response.data.courseDetails.instructorName,
});
  ...
  if (
    ...
    const cd = studentCurrentCourseProgress.courseDetails;

    setCurrentCourseMeta({
      id: cd._id,
      title: cd.title,
      instructorName: cd.instructorName,
    });
  }
}, [studentCurrentCourseProgress, currentCourseMeta]);
  ...
  const courseTitle =
    studentCurrentCourseProgress?.courseDetails?.title || "Course Progress";
  const curriculum =
          ...
          <DialogHeader>
            ...
            <DialogDescription className="flex flex-col gap-3">
              ...
              <div className="flex flex-row gap-3">
                ...
                <Button
                  onClick={() => navigate(`/user/course/${id}/quiz-view/`)}
                >
                  Take Final Exam
                </Button>
              </div>
