...
export const AddCourse = () => {
  ...
  return (
   ...
   <button  className="px-8 py-2 rounded-full cursor-pointer relative bg-slate-900 text-white text-sm hover:shadow-2xl hover:shadow-white/[0.4] transition duration-200 border border-slate-800" onClick={() => navigate('/admin/create-course')}>
